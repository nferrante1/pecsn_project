//
// Generated file, do not edit! Created by nedtool 5.6 from transaction.msg.
//
...
int Transaction::getGate() const
{
    return this->gate;
}

void Transaction::setGate(int gate)
{
    this->gate = gate;
}
...
TransactionDescriptor::TransactionDescriptor() : omnetpp::cClassDescriptor("pecsn_project::Transaction", "omnetpp::cMessage")
{
...
int TransactionDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='g' && strcmp(fieldName, "gate")==0) return base+1;
...
std::string TransactionDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return long2string(pp->getGate());
        default: return "";
    }
}
...
bool TransactionDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setGate(string2long(value)); return true;
